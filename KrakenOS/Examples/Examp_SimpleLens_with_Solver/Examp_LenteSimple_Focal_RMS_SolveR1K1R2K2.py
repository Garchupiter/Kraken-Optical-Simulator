...
class Function2Optimize:
    def __init__(self, system, raykeeper, effl, Surf, w, AperVal, AperType):
        ...
        self.P.Samp, self.P.Ptype, self.P.FieldType = 6, "square", "angle"
    ...
    def EFFL(self, V):
        ...
        self.system.SDT[1].k  = V[2]

        self.system.SDT[2].Rc = V[1]
        self.system.SDT[2].k  = V[3]
...
K1=0.0
K2=0.0
R = scipy.optimize.least_squares(MyFun.EFFL, [R0, R1, K1, K2])


[R0,R1,K1, K2] = R.x


print("Resulting R0: ", R0, " R1: ", R1, " K1: ", K1, " K2: ", K2)
Lens.SDT[1].Rc = R0
Lens.SDT[1].k = K1
...
P.Samp, P.Ptype, P.FieldX, P.FieldType = 8, "square", 0, "angle"
