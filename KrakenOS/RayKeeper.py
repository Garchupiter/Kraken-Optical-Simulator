...
#         if (self.SYSTEM.val == 0):
#             self.invalid_vld = np.append(self.vld, 0)
#             self.invalid_SURFACE.append( (self.SYSTEM.SURFACE))
#             self.invalid_NAME.append( (self.SYSTEM.NAME))
#             self.invalid_GLASS.append( (self.SYSTEM.GLASS))
#             self.invalid_S_XYZ.append( (self.SYSTEM.S_XYZ))
#             self.invalid_T_XYZ.append( (self.SYSTEM.T_XYZ))
#             self.invalid_XYZ.append( (self.SYSTEM.XYZ))
#             self.invalid_OST_XYZ.append( (self.SYSTEM.OST_XYZ))
#             self.invalid_S_LMN.append( (self.SYSTEM.S_LMN))
#             self.invalid_LMN.append( (self.SYSTEM.LMN))
#             self.invalid_R_LMN.append( (self.SYSTEM.R_LMN))
#             self.invalid_N0.append( (self.SYSTEM.N0))
#             self.invalid_N1.append( (self.SYSTEM.N1))
#             self.invalid_WAV.append( (self.SYSTEM.WAV))
#             self.invalid_G_LMN.append( (self.SYSTEM.G_LMN))
#             self.invalid_ORDER.append( (self.SYSTEM.ORDER))
#             self.invalid_GRATING.append( (self.SYSTEM.GRATING))
#             self.invalid_DISTANCE.append( (self.SYSTEM.DISTANCE))
#             self.invalid_OP.append( (self.SYSTEM.OP))
#             self.invalid_TOP_S.append( (self.SYSTEM.TOP_S))
#             self.invalid_TOP.append( (self.SYSTEM.TOP))
#             self.invalid_ALPHA.append( (self.SYSTEM.ALPHA))
#             self.invalid_BULK_TRANS.append( (self.SYSTEM.BULK_TRANS))
#             self.invalid_RP.append( (self.SYSTEM.RP))
#             self.invalid_RS.append( (self.SYSTEM.RS))
#             self.invalid_TP.append( (self.SYSTEM.TP))
#             self.invalid_TS.append( (self.SYSTEM.TS))
#             self.invalid_TTBE.append( (self.SYSTEM.TTBE))
#             self.invalid_TT.append( (self.SYSTEM.TT))
#         else:
#             self.vld = np.append(self.vld, 1)
#             self.valid_vld = np.append(self.vld, 0)
#             self.valid_SURFACE.append( (self.SYSTEM.SURFACE))
#             self.valid_NAME.append( (self.SYSTEM.NAME))
#             self.valid_GLASS.append( (self.SYSTEM.GLASS))
#             self.valid_S_XYZ.append( (self.SYSTEM.S_XYZ))
#             self.valid_T_XYZ.append( (self.SYSTEM.T_XYZ))
#             self.valid_XYZ.append( (self.SYSTEM.XYZ))
#             self.valid_OST_XYZ.append( (self.SYSTEM.OST_XYZ))
#             self.valid_S_LMN.append( (self.SYSTEM.S_LMN))
#             self.valid_LMN.append( (self.SYSTEM.LMN))
#             self.valid_R_LMN.append( (self.SYSTEM.R_LMN))
#             self.valid_N0.append( (self.SYSTEM.N0))
#             self.valid_N1.append( (self.SYSTEM.N1))
#             self.valid_WAV.append( (self.SYSTEM.WAV))
#             self.valid_G_LMN.append( (self.SYSTEM.G_LMN))
#             self.valid_ORDER.append( (self.SYSTEM.ORDER))
#             self.valid_GRATING.append( (self.SYSTEM.GRATING))
#             self.valid_DISTANCE.append( (self.SYSTEM.DISTANCE))
#             self.valid_OP.append( (self.SYSTEM.OP))
#             self.valid_TOP_S.append( (self.SYSTEM.TOP_S))
#             self.valid_TOP.append( (self.SYSTEM.TOP))
#             self.valid_ALPHA.append( (self.SYSTEM.ALPHA))
#             self.valid_BULK_TRANS.append( (self.SYSTEM.BULK_TRANS))
#             self.valid_RP.append( (self.SYSTEM.RP))
#             self.valid_RS.append( (self.SYSTEM.RS))
#             self.valid_TP.append( (self.SYSTEM.TP))
#             self.valid_TS.append( (self.SYSTEM.TS))
#             self.valid_TTBE.append( (self.SYSTEM.TTBE))
#             self.valid_TT.append( (self.SYSTEM.TT))
...
#         self.SURFACE.append( (self.SYSTEM.SURFACE))
#         self.NAME.append( (self.SYSTEM.NAME))
#         self.GLASS.append( (self.SYSTEM.GLASS))
#         self.S_XYZ.append( (self.SYSTEM.S_XYZ))
#         self.T_XYZ.append( (self.SYSTEM.T_XYZ))
#         self.XYZ.append( (self.SYSTEM.XYZ))
#         self.OST_XYZ.append( (self.SYSTEM.OST_XYZ))
#         self.S_LMN.append( (self.SYSTEM.S_LMN))
#         self.LMN.append( (self.SYSTEM.LMN))
#         self.R_LMN.append( (self.SYSTEM.R_LMN))
#         self.N0.append( (self.SYSTEM.N0))
#         self.N1.append( (self.SYSTEM.N1))
#         self.WAV.append( (self.SYSTEM.WAV))
#         self.G_LMN.append( (self.SYSTEM.G_LMN))
#         self.ORDER.append( (self.SYSTEM.ORDER))
#         self.GRATING.append( (self.SYSTEM.GRATING))
#         self.DISTANCE.append( (self.SYSTEM.DISTANCE))
#         self.OP.append( (self.SYSTEM.OP))
#         self.TOP_S.append( (self.SYSTEM.TOP_S))
#         self.TOP.append( (self.SYSTEM.TOP))
#         self.ALPHA.append( (self.SYSTEM.ALPHA))
#         self.BULK_TRANS.append( (self.SYSTEM.BULK_TRANS))
#         self.RP.append( (self.SYSTEM.RP))
#         self.RS.append( (self.SYSTEM.RS))
#         self.TP.append( (self.SYSTEM.TP))
#         self.TS.append( (self.SYSTEM.TS))
#         self.TTBE.append( (self.SYSTEM.TTBE))
#         self.TT.append( (self.SYSTEM.TT))
