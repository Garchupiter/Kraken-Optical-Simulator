...
ED0 = np.zeros(20)
ED0[2] = 1 * 4.458178314555000E-018
...
ED1 = np.zeros(20)
ED1[0] = 1 * 2.059727552003000E-005
ED1[1] = 1 * -1.135080732384000E-009
Corrector_c1.AspherData = ED1

############################################################################

Corrector_c2 = kn.surf()
Corrector_c2.Thickness = 329.296
...
AB = kn.Seidel(Telescopio, sup, W, AperType, AperVal, field, fieldType)
