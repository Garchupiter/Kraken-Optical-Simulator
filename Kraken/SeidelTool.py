...
Welford, W.T. (1986). Aberrations of Optical self.SYSTEMs (1st ed.). Routledge. https://doi.org/10.1201/9781315136530


Warren Smith - Modern optical engineering_ the design of optical self.SYSTEMs-McGraw Hill (2008).pdf
...
class Seidel:
    ...
    def calculate(self):
        ...
        """ --------------------- Aspheric ----------------------------------------
           ...
           Warren Smith - Modern optical engineering_ the design of optical self.SYSTEMs
